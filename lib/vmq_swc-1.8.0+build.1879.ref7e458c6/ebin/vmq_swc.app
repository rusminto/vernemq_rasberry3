    ...
    [{description,
     ...
     {modules,
         [vmq_churney,vmq_swc,vmq_swc_app,vmq_swc_db,vmq_swc_db_leveldb,
          ...
          vmq_swc_metrics,vmq_swc_plugin,vmq_swc_plumtree_peer_service,
          vmq_swc_plumtree_peer_service_events,
          vmq_swc_plumtree_peer_service_gossip,
          vmq_swc_plumtree_peer_service_manager,vmq_swc_store,
          vmq_swc_store_batcher,vmq_swc_store_sup,vmq_swc_sup]}]}.
